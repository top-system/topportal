...
namespace TopSystem\TopPortal\Commands;
...
use TopSystem\TopPortal\PortalServiceProvider;
...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'topportal:install';
     ...
     * @var string
     */
    protected $description = 'Install the Portal Admin package';
    ...
    public function handle(Filesystem $filesystem)
    {
        ...
        $this->call('vendor:publish', ['--provider' => PortalServiceProvider::class, '--tag' => $tags]);
        ...
        $this->call('db:seed', ['--class' => 'PortalDummyDatabaseSeeder']);
